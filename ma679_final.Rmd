...
```{r}
selected_data <- select(filtered_data123, "NRD_VisitLink",I10_PR1:I10_PR25,I10_DX1:I10_DX40,admission_count,readmission_mark,NRD_VisitLink)
```
